    ...
    <div className="container prices-information-page">
        <div className="row">
            <div className="col prices-info-text">
                ...
                Det gjør at vi kan få dokumentert på flere hold samtidig, noe som er spesielt fint i de øyeblikkene dere selv ikke får vært til stede, men da likevel kan få ta del i gjennom bildene i etterkant.</p>
